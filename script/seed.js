...
async function seed() {
  ...
  const products = await Promise.all([
    Product.create({
      ...
      quantity: 10,
      description:
        "NEW! A pioneering collaboration with Dr. William Li, we bring you Pure Plant. Walnuts have a wealth of polyunsaturated fats.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "NEW! A pioneering collaboration with Dr. William Li, we bring you Pure Plant. Chinese 5 Spice refers to the blending of star anise, cloves, Chinese cinnamon, Szechuan peppercorns, and fennel seeds",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "One of our darkest chocolate bar parfum features the smoky aromas of Alderwood smoked salt with a crunch of Ghanaian cocoa nibs.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "A curious pairing of chocolate + cheese. The first chocolate bar in a soon to be launched new cheese and chocolate series",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "Fruitwood smoked, uncured bacon from a beloved sustainable family farm in New Hampshire, finished with a sprinkling of Alderwood smoked salt.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "Adaptogenic ceremonial matcha green tea and spirulina with Ghanaian cacao nibs craft an iron-rich dark chocolate experience.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "A curious and delicious marriage of our house-roasted bananas, their peels, and Sri Lankan coconut permeate our dark chocolate with husky, tropical notes.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "Trace mineral-rich, Himalayan pink salt is sustainably hand harvested, then blended with burnt sugar caramel and encased in bittersweet dark chocolate.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "Turmeric and ginger root, both adaptogens, are blended with golden milk botanicals, crispy coconut, and Telicherry peppercorns in deep milk chocolate.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "All natural fruitwood-smoked bacon is baked in small batches before we hand chop it into fine nibbles.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "Deep milk chocolate melts into the mineral and sumptuous taste of Fleur de Sel grey sea salt and roasted almonds, reminiscent of Marcona, Spain.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "This floral nectar of raw honey, harmonizes with the intensity of dark chocolate. Divinely decadent with all of the wellness benefits of these two beloved ingredients.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "Your senses of sight, smell, and taste will collectively surrender to the inebriating union of Forbidden Root Aboot Stoot Beer, Alderwood Smoked Salt and deep, dark chocolate.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "A molten center of burnt sugar caramel, infused with our house-made black cacao sea salt, encased in our proprietary dark chocolate.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "For those who adore pralines, hazelnuts and Italian dulce, these decadent bonbons will be your new craving. 45% cacao deep milk chocolate pairs perfectly with the rich, Piemonte hazelnuts, while crispy crepes add a light crunch.",
      imageURL:
    ...
    Product.create({
      ...
      quantity: 10,
      description:
        "NEW! A pioneering collaboration with Dr. William Li, we bring you Pure Plant. Each of our new Pure Plant bars helps to activate your body’s defenses in powerful ways. They work to address the needs of the body to heal, regenerate and be nourished.",
      imageURL:
